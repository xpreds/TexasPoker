...
public class Evaluator {
	...
	//evaluate method calculates the best hand from the seven cards that each player has (seven cards is the sum of the
	// players own cards and the cards on the board)
	//this class works with the combinations class
	//combinations class chooses five out of the seven cards , all the combinations sum up to 21 different probabilities
	//all the probabilities are checked and the best one is kept in the game class
	// then the probability for the players having the same hands are checked.
	// if that is the case, than the program looks for the high cards
